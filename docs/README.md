...
- `results`: Top-level folder which contains all viewable results. Organized by strategy.
- Each strategy contains results of backtesting of various assets, organized by time-period.
