...
def example():
    ...
    metrics_training = dict(Total_Return=.001,Sharpe=1.777, Alpha=False, Number_of_Trades=False)
    training_state['metrics'] = metrics_training

    training_state['strategies'] = dict()
    training_state['strategies']['momentum_trending'] = dict(z_threshold=  1.999  , roll=30)
    # training_state['strategies']['cointegration'] = dict(z_threshold = 1.7, roll = 25 )
    training_state['strategies']['cross_asset_mv'] = dict(z_threshold= 2)
    training_state['strategies']['mv'] = dict(z_threshold=1.999 , roll=55)
    ...
    validating_state['metrics'] =  dict(Total_Return= 0.001,Sharpe=1.555,  Alpha= False, Number_of_Trades=False)
    validating_state['strategies'] = dict()

    validating_state['strategies']['momentum_trending'] = dict(z_threshold= 1.999  , roll=30)
    ...
    # validating_state['strategies']['mv'] = dict(z_threshold= 1.999   , roll=30)
    ...
    testing_state['strategies']['momentum_trending'] = dict(z_threshold= 1.99 , roll=  30)
